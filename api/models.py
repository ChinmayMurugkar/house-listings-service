...
class House(models.Model):
    area_unit = models.CharField(max_length=10, null=True, blank=True, default='SqFt')
    ...
    rentzestimate_amount = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    zestimate_amount = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
